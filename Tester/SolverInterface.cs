...
namespace Tester{
    ...
    internal interface ISolver
    {
        ...
        //The constructor should do only minimal work, since all solvers are instanced when the Opossum window loads.

        bool RunSolver(List<Variable> variables, Func<List<decimal>,double> evaluate, string preset, string installFolder);
